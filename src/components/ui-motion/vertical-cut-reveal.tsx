// Source: https://github.com/danielpetho/fancy/blob/f9f62c61207b2dd3210476dd98af3c9a5be24094/src/fancy/components/text/vertical-cut-reveal.tsx
// Author: Daniel Petho, Fancy Components. Found via https://21st.dev/@danielpetho/components/vertical-cut-reveal
// License: MIT, Copyright (c) 2024 Daniel Petho. Full text: licenses/fancy-components.txt in this library.
// Changes for this library: reduced-motion guard (text renders in place); the auto-start effect lists its dependency.
"use client"
