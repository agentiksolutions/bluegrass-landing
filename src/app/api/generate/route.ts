...
const websitePrompt = (formData: {
  ...
  location: string;
  vibe: string;
}) => `You are a web designer for Bluegrass Advisory Group. Generate website content for a small business. Be specific to their actual business, with no generic filler. Write like a human, not a marketing bot.
